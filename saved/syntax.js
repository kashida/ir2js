module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c303 = function(marker) {
              return $.parentCall(marker);
            },
        peg$c304 = function(args) {
              return $.parentCall(args);
            },
        peg$c305 = function(type, expr) {
              return [$.cast(type), '(', expr, ')'];
            },
        peg$c306 = function(type) { return type; },
        peg$c307 = function(type) { return $.type(type); },
        peg$c308 = ":=",
        peg$c309 = { type: "literal", value: ":=", description: "\":=\"" },
        peg$c310 = function(left, right) {
              return [$.prepend(['var ', left]), left, ' = ', right]
            },
        peg$c311 = function(stmt) { return [stmt, $.marker('b')]; },
        peg$c312 = function(cond) { return ['if (', cond, ')']; },
        peg$c313 = function(cond) { return ['else if (', cond, ')']; },
        peg$c314 = function(cond) { return ['while (', cond, ')']; },
        peg$c315 = ";",
        peg$c316 = { type: "literal", value: ";", description: "\";\"" },
        peg$c317 = function(initializer, test, counter) {
              return [
                $.prepend(initializer),
                'for (;',
                test ? [' ', test] : null,
        ...
        peg$c318 = function(iter, collection) {
              return [
                $.prepend(['var ', iter]),
        ...
        peg$c322 = function(expr) { return ['switch (', expr, ')']; },
        peg$c323 = function(selector) { return ['case ', selector, ':']; },
        peg$c324 = function() { return 'default:'; },
        peg$c325 = function(identifier) { return ['catch (', identifier, ')']; },
        peg$c326 = /^[+*&]/,
        ...
        peg$c332 = function(member, name, access, marker, type, args) {
              return $.paramLine(
                  name, !!member, access || '', ['!', type], marker || '',
                  ['new ', $.type(type), args]);
            },
        peg$c333 = function(member, name, access, type, marker, init) {
              return $.paramLine(
                  name, !!member, access || '', type, marker || '', init);
            },
        peg$c334 = function(tmpl, type) {
              return $.tmplAndTypeLine(tmpl, type);
            },
        peg$c335 = function() { $.grammar = 's'; return '--'; },
        peg$c336 = function() { return 'undefined'; },
        peg$c337 = function() { return 'null'; },
        peg$c338 = "b",
        peg$c339 = { type: "literal", value: "b", description: "\"b\"" },
        peg$c340 = function() { return 'boolean'; },
        peg$c341 = "s",
        peg$c342 = { type: "literal", value: "s", description: "\"s\"" },
        peg$c343 = function() { return 'string'; },
        peg$c344 = "n",
        peg$c345 = { type: "literal", value: "n", description: "\"n\"" },
        peg$c346 = function() { return 'number'; },
        peg$c347 = "f",
        peg$c348 = { type: "literal", value: "f", description: "\"f\"" },
        peg$c349 = function(params, ret) {
              if (!params && !ret) { return '!Function'; }
              var f = ['function', params ? params : '()'];
              ret && f.push(ret);
              return f;
            },
        peg$c350 = function(t) { return ['...[', t, ']']; },
        peg$c351 = function(t) { return [t, '=']; },
        peg$c352 = "A",
        peg$c353 = { type: "literal", value: "A", description: "\"A\"" },
        peg$c354 = function(e) {
              return ['!Array.<', e, '>'];
            },
        peg$c355 = function() { return '!Array'; },
        peg$c356 = "O",
        peg$c357 = { type: "literal", value: "O", description: "\"O\"" },
        peg$c358 = function(k, v) {
              return ['!Object.<', k, ',', v, '>'];
            },
        peg$c359 = function(v) {
              return ['!Object.<string,', v, '>'];
            },
        peg$c360 = function() { return '!Object'; },
        peg$c361 = "Array",
        peg$c362 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c363 = "Object",
        peg$c364 = { type: "literal", value: "Object", description: "\"Object\"" },
        peg$c365 = "boolean",
        peg$c366 = { type: "literal", value: "boolean", description: "\"boolean\"" },
        peg$c367 = "number",
        peg$c368 = { type: "literal", value: "number", description: "\"number\"" },
        peg$c369 = "string",
        peg$c370 = { type: "literal", value: "string", description: "\"string\"" },
        peg$c371 = "undefined",
        peg$c372 = { type: "literal", value: "undefined", description: "\"undefined\"" },
        peg$c373 = function(n) { return n; },
        peg$c374 = function(initId, ids) {
              var tmplIds = [];
              tmplIds.push(initId);
        ...
        peg$c375 = function(path, name) {
              return [$.pkg(), '.', path, name];
            },
        peg$c376 = function(id, tmpl) {
              var value = ['!', id];
              if (tmpl) {
                value.push('.', tmpl);
              }
        ...
        peg$c379 = function(a, x) {
              return x.length > 0 ? ['(', a, x, ')'] : a;
            },
        peg$c380 = function(id, tmpl) {
              if (!tmpl) {
                return id;
              }
              return [id, '.', tmpl]
                      ...
                      if (s9 !== peg$FAILED) {
                        ...
                        if (s10 !== peg$FAILED) {
                          ...
                          if (s11 !== peg$FAILED) {
                            ...
                            if (s12 !== peg$FAILED) {
                              peg$reportedPos = s0;
                              s1 = peg$c332(s1, s3, s5, s8, s10, s12);
                              s0 = s1;
                            } else {
                              peg$currPos = s0;
                              s0 = peg$c12;
